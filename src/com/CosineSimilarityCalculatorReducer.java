...
public class CosineSimilarityCalculatorReducer extends Reducer<Text,Text,Text,Text> {
    ...
    public void reduce(Text key, Iterable<Text> values,Context context) throws IOException, InterruptedException {	
    	 ...
    	 * */
    		...
    		/**
    		 * current unigram doesn't exist in base doc
    		 * pass, base the cosine similarity component value is zero
    		 * 
    		 * */
    		}
    		...
    		/**
    		 * there exists no current unigram in the mysterious doc
    		 * pass, because this leads a zero for the corresponding calculation
    		 * for the two TFIDF (because one of the two is zero)
    		 * */
    	}
