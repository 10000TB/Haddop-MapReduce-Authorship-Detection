...
//	private static String switchStr="GenerateBaseAttributes";
/**
  *   Generate the author attributes 
  *                                                              MysteriousDoc
  * $HADOOP_HOME/bin/hadoop jar SDetector.jar com.SDetector /data/books.txt /output101 /output102 /output103 /baseAuthorAttributes101
  * 
  * */	
 ...
 *                                                              MysteriousDoc
 * $HADOOP_HOME/bin/hadoop jar SDetector.jar com.SDetector /test_mysterious_one /output1 /output2 /baseAuthorAttributes /output4 /output5 /output6 /output7 /output8
 * 
 * */
...
//
//		     job.setNumReduceTasks(1000);/**  Due to large amount of lines of records generated fromlast reducer it would better to separate them into multiple files by setting num of reducers tasks * */
...
//		     
//		     job2.setNumReduceTasks(500);
//		     job2.setMapperClass(AuthorTermFrequencyMapper.class);
//		     job2.setReducerClass(AuthorTermFrequencyReducer.class);
//		     
...
//		     job2.waitForCompletion(true);
	     ...
	     {
	    	 /**
	    	  * $HADOOP_HOME/bin/hadoop jar CosineSimilarityCalculator.jar com.SDetector /test_mysterious_one /Cos1 /Cos2 /baseAuthorAttributes102 /Cos4 /Cos5 /Cos6 /Cos7 /Top10
	    	  * 
	    	  * 
	    	  * 
		      * if there are more than 4 arguments
		      * it meaning we need to calculate cosine similarity and generate top
		      * 
		      * */
		    	 
		    	 /**
		    	  * By Now the attributes for each author have been already generated
		    	  * Which means that the 5th parameter is that file
		    	  * 
		    	  * And the 6th parameter is the final output
		    	  * */
